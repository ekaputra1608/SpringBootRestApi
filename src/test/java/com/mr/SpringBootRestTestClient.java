...
public class SpringBootRestTestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/SpringBootRestApi/api/v1";
    ...
    private static void createUser() {
        ...
        RestTemplate restTemplate = new RestTemplate();
        User user = new User(0L, "Sarah", 51, 134D);
    ...
    private static void updateUser() {
        ...
        RestTemplate restTemplate = new RestTemplate();
        User user = new User(1L, "Tomy", 33, 70000D);
